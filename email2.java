...
public class email2 {
    ...
    {
        String from = "yaseenyoussef7@gmail.com";                          //sender e-mail
        String password = "you00ya11";                       //sender password
        ...
        try {
            Message message = new MimeMessage(session);             //make object from message of the session that we made above
